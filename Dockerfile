...
# renovate: datasource=deb depName=samba versioning=deb registryUrl=http://ports.ubuntu.com/ubuntu-ports/?suite=noble,noble-updates,noble-backports&components=main,universe,restricted,multiverse&binaryArch=amd64
