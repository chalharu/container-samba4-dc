...
# renovate: datasource=deb depName=samba-ad-dc versioning=loose registryUrl=http://ports.ubuntu.com/ubuntu-ports?release=noble&components=universe&binaryArch=arm64
